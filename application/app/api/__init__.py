...
from .audioCharPairsAPI.audioCharPairsAPI import AudioCharPairsAPI
...
api.add_resource(AudioCharPairsAPI,
                 '/audioCharPairsAPI/<page>/<size>/',
                 '/audioCharPairsAPI',
                 endpoint='audioCharPairsAPI')
